<?php
/**
 * Corrective Action - Read-Only View
 *
 * Variables from controller:
 * - $header (object): audit header info
 * - $ca (object): corrective action record
 * - $pelaksanaan_id (int): pelaksanaan audit ID
        ...
        <div class="container">
            <div class="card card-stretch shadow card-custom">
                <div class="card-header justify-content-between d-flex align-items-center">
                    <h2 class="m-0"><i class="<?= $icon; ?> text-primary mr-2"></i>View Corrective Action</h2>
                    <a href="<?= site_url('corrective_action'); ?>" class="btn btn-danger"><i class="fa fa-reply"></i> Kembali</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- ================ BACK BUTTON ================ -->
                    <div class="mt-4">
                        <a href="<?= site_url('corrective_action/index'); ?>" class="btn btn-secondary">
