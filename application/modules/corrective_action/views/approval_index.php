		...
		<div class="container">
			<div class="card card-stretch shadow card-custom">
				<div class="card-header">
					<h2 class="mt-5"><i class="<?= $icon; ?> mr-2"></i>Approval Corrective Action</h2>
				</div>
				<div class="card-body">
										...
										foreach ($data as $dt) : $n++; ?>
											<tr>
												...
												<td class="text-center">
													<?php if ($dt->status_ca == 'waiting_approval') : ?>
														<span class="label label-lg label-light-warning label-inline">Waiting Approval</span>
												...
												<td class="text-center">
													<?php if ($dt->status_ca == 'waiting_approval') : ?>
														...
														<a href="<?= site_url('corrective_action/approval_form/' . $dt->ca_id); ?>" class="btn btn-sm btn-success" title="Approve">
