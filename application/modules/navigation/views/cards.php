			...
			<div class="card card-stretch shadow card-custom">
				<div class="card-header">
					...
					<div class="mt-4 float-right">
						<a href="<?= base_url('navigation'); ?>" class="btn btn-secondary mr-2" title="Kembali ke Navigation">
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Card Navigation</h5>
...
<script>
	$(document).ready(function() {
		...
		$(document).on('click', '#add-card', function() {
			$('.modal-title').html('Tambah Card Navigation');
		...
		$(document).on('click', '.edit-card', function() {
			...
			$('.modal-title').html('Edit Card Navigation');
			$('#modalCard').modal('show');
		...
		$(document).on('click', '.save-card', function() {
			...
			const form = $modal.find('#form-card')[0] || $modal.find('form')[0];
			if (!form) return;

			const $name = $(form).find('#name');
			const $linkMenu = $(form).find('#link_menu');
			const $linkCustom = $(form).find('#link_custom');
			validation($name);
