			...
			<div class="card card-stretch shadow card-custom">
				<div class="card-header">
					...
					<div class="mt-4 float-right ">
						<button type="button" class="btn btn-primary" id="add" title="Add Department">
									...
									<?php if ($data) foreach ($data as $k => $v) : $k++; ?>
										<tr>
											...
											<td class="text-center">
												...
												<?php else : ?>
													<span class="label label-danger label-inline">Inactive</span>
												<?php endif; ?>
											</td>
											<td class="text-center">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-end">
				...
				<button type="button" class="btn btn-primary save min-w-100px"><i class="fa fa-check mr-1"></i>Simpan</button>
			</div>
		</div>
	</div>
</div>
			...
			Swal.fire({
				...
				if (value.isConfirmed) {
					$.ajax({
						...
						complete: function() {
							btn.attr('disabled', false).html('<i class="fa fa-check mr-1"></i>Simpan')
						},
