  ...
  <table class="table table-bordered">
    <tr>
      ...
      <td rowspan="3" class="text-center align-middle">
        <h2 class="bold"><strong><?= strtoupper($data->name); ?></strong></h2>
      </td>
      <td rowspan="">Nomor</td>
      <td rowspan=""><?= $data->nomor; ?></td>
    </tr>
    <tr>
      <td>Tgl. Terbit</td>
      <td><?= ($data->approved_at) ? date("d, M y", strtotime($data->approved_at)) : '~'; ?></td>
    </tr>
    <tr>
      <td>Revisi</td>
      <td><?= (($data->revision >= 0)) ? "Rev." . $data->revision : '~'; ?></td>
    </tr>
  </table>
      ...
      <?php if ($data->link_video) : ?>
        <tr>
          <td class="text-center">
            <iframe width="320" src="https://www.youtube.com/embed/<?= ($data->link_video); ?>" title="<?= $data->name; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </td>
        </tr>
      <?php else : ?>
        <tr>
